...
namespace X68fpjc.Jellyfin.EPGStation.OpenAPI.Api
{
    ...
    /// </summary>
    public interface IStoragesApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IStoragesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<StorageInfo> StoragesGetAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<StorageInfo>> StoragesGetWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IStoragesApi : IStoragesApiSync, IStoragesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class StoragesApi : IStoragesApi
    {
        private X68fpjc.Jellyfin.EPGStation.OpenAPI.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="StoragesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public StoragesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public StoragesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public StoragesApi(X68fpjc.Jellyfin.EPGStation.OpenAPI.Client.Configuration configuration)
        {
        ...
        public StoragesApi(X68fpjc.Jellyfin.EPGStation.OpenAPI.Client.ISynchronousClient client, X68fpjc.Jellyfin.EPGStation.OpenAPI.Client.IAsynchronousClient asyncClient, X68fpjc.Jellyfin.EPGStation.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        public X68fpjc.Jellyfin.EPGStation.OpenAPI.Client.ApiResponse<StorageInfo> StoragesGetWithHttpInfo(int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<StorageInfo>("/storages", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("StoragesGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StorageInfo</returns>
        public async System.Threading.Tasks.Task<StorageInfo> StoragesGetAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StorageInfo)</returns>
        public async System.Threading.Tasks.Task<X68fpjc.Jellyfin.EPGStation.OpenAPI.Client.ApiResponse<StorageInfo>> StoragesGetWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<StorageInfo>("/storages", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
